"""Run Study 2 LL (LLM-driven selection) on GPT-5-Chat.

5 episodes × budgets [1, 3, 5], full QA + state captured per checkpoint.
"""
...
BUDGETS = [3, 5, 10]
MODE = "learner_led"
LOG_PATH = PROJECT_ROOT / "logs" / "study2ll_gpt5chat_5ep_b3-5-10.jsonl"
